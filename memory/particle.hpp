...
namespace MDSIM {
  namespace memory {
    ...
    public:
      ...
      inline vector3D<floatType> getPosition() const { return _position; }
      inline vector3D<floatType> getVelocity() const { return _velocity; }
      inline vector3D<floatType> getForce()    const { return _force; }
      inline floatType getMass()               const { return _mass; }
    };
